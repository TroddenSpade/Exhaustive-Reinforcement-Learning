...
FILE_PATH = os.path.join(PATH ,"SAC_res.pkl")
GIF_PATH = os.path.join(PATH , "gifs")
ROOT_PATH = os.path.abspath(
    os.path.join(os.path.dirname(__file__), '../../../..'))
sys.path.insert(0, ROOT_PATH)

from code.DRL.AC.SAC.torch import SAC
...
if __name__ == "__main__":
    ...
    plt.plot(smoothed_times_mean, 'y', label='SAC', linewidth=2)
    plt.fill_between(
    ...
    plt.plot(smoothed_rewards_mean, 'deepskyblue', label='SAC', linewidth=2)
    plt.fill_between(
