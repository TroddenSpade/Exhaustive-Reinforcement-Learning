...
FILE_PATH = os.path.join(PATH ,"TD3_res.pkl")
GIF_PATH = os.path.join(PATH , "gifs")
ROOT_PATH = os.path.abspath(
    os.path.join(os.path.dirname(__file__), '../../../..'))
sys.path.insert(0, ROOT_PATH)

from code.DRL.DPG.TD3.torch import TD3
...
if __name__ == "__main__":
    ...
    n_episodes = 1000
    args = {
        "create_env_fn": DefineEnv("BipedalWalker-v3"),
        "actor_kwargs":{
